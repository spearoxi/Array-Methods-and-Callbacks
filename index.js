...
function getFinals(data) {
   const finalstage = fifaData.filter(item => item.Stage === 'Final');
   return finalstage;
};
...
function getWinnersByYear(getYears, getWinners) {
    ...
    const year = getYears.forEach(function(item){
        return headline.push(`In ${item}, ${getWinners.item} won the world cup!`);
    });
